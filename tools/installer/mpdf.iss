...
; Pagina de avisos (licenca AGPL do iText e afins) antes da instalacao.
InfoBeforeFile=..\..\docs\licencas\AVISO-USO-INTERNO.txt
...
; Textos de licenca de terceiros (AGPL/MIT/BSD) + aviso de uso interno, para consulta pos-instalacao.
