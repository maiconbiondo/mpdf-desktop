...
public partial class ExportImageDialog : Window
{
    ...
    /// Plano 14 (Task 4): janela sem moldura (superfície escura rounded) — arrastar pelo header substitui
    /// o arraste da title bar nativa (só UX de janela, nenhuma mudança na lógica de exportar).
