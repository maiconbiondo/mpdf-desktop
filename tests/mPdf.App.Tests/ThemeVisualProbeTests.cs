...
public class ThemeVisualProbeTests
{
    ...
    private static void RunProbe()
    {
        ...
        try
        {
            ...
            // Plano 14 (Task 1): mescla [tokens ATIVO, mPdfTheme] igual App.xaml — sem o dicionário de
            // tokens, os {DynamicResource Cor.*} do tema ficariam sem resolver nesta sonda sem Application
            // (a janela renderiza mesmo assim, mas plana); com ele, o PNG mostra o chrome ESCURO real.
