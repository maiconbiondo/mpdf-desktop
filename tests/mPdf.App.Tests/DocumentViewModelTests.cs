...
public class DocumentViewModelTests
{
    ...
    [Fact] // sem cor de preenchimento selecionada (default null) -> Rectangle commitado SEM fill.
    public async Task CommitDrawingAsync_RectangleTool_NoFillSelected_FillArgbNull()
    {
        var (doc, fake, _, errors) = BuildForAnnotations();
        using var d = doc;
        d.ActiveTool = AnnotationTool.Rectangle;
