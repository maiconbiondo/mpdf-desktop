...
public class ConfiguracoesDialogTests
{
    ...
    [Fact] // Plano 23: o toggle de tema saiu daqui (virou botão sol/lua no topo). O de Nitidez
    // continua e reflete o estado do VM.
    public void ConfiguracoesDialog_Constructed_NitidezCheckBoxReflectsVm()
    {
        RunSta(() =>
        {
            var vm = BuildVm();
            ...
            try
            {
                ...
                Assert.Null(dialog.FindName("TemaEscuroCheckBox")); // removido
