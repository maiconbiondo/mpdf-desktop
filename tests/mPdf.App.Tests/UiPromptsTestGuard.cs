...
internal static class UiPromptsTestGuard
{
    ...
    internal static void Install()
    {
        ...
        UiPrompts.CreatePdfADialog = () => new ThrowingPdfADialogService();
    }
...
internal sealed class ThrowingPdfADialogService : IPdfADialogService
{
    public PdfAEscolha? Perguntar() =>
        throw UiPromptsTestGuard.Guard(nameof(UiPrompts.CreatePdfADialog), "um IPdfADialogService fake");
}
